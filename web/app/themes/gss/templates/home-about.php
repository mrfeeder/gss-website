<div class="container-fluid">
	<div class="row our-services">
		<div class="col-md-12 our-services-top">
			<p>What We Do</p>
			<h1>OUR SERVICES</h1>
		</div>
			...
			<div class="row">
				<div class="col-md-4">
					...
					<div class="items row">
						...
						<h3>HR, Payroll & Accounting Services</h3>
						<p>It won’t be a bigger problem to find one video game lover in your neibor</p>
					</div>
				...
				<div class="col-md-4">
					...
					<div class="items row">
						...
						<h3>Data Processing and General Administration</h3>
						<p>It won’t be a bigger problem to find one video game lover in your neibor</p>
					</div>
				</div>
